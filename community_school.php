        ...
        <p style="height:40px">
            ...
            <script>
                ...
                function searchSchool() {
                    ...
                    var eduSectorInput = document.getElementById("eduSector").value;
                    var schoolTypeInput = document.getElementById("schoolType").value;
                    var suburbInput = document.getElementById("suburb").value;
                    eduSectorInput = trim(eduSectorInput);
                    schoolTypeInput = trim(schoolTypeInput);
                    suburbInput = trim(suburbInput);
                    alert(suburbInput);
                    alert("999");
                    $.post('phpdb/php_school.php', {selectedEduSector: eduSectorInput, selectedType: schoolTypeInput, selectedSuburb: suburbInput}, function (data) {
                        if (data !== "") {
                            alert(data+"|");
                                ...
                                (function (s) {
                                    geocoder.geocode({'address': fullAddress[s]}, function (results) {
                                        ...
                                        content = "<div>School Name:&nbsp;&nbsp;&nbsp;" + nameOfScls[s]
                                                ...
                                                + "</div><br><div><button onclick='displayRoute()'>Get Direction</button></div>";
                            ...
                            alert("Apologise! No matching results.");
                        }
                    });
                }
...
<!--        <div class="jumbotron container">
            <h1>Search schools in your community</h1>
            <p>some words here...</p>
        </div>-->
        <div class="container">
...
<!--                </div>
                <div class="form-group">-->
                    <label class="col-sm-2 control-label">Education Sector:&nbsp;(optional)</label>
                    <div class="col-sm-10">
                        <select id="eduSector">
                ...
                <div class="form-group">-->
                    ...
                    <div class="col-sm-10">
                        <select id="schoolType">
                            ...
                            <option value="Primary/Secondary Combined">Primary/Secondary Combined</option>
